package com.vsoft.apps.billing.utils;
...
public class SupportUtils {
     ...
     * @param listener a {@link com.vsoft.apps.billing.utils.SupportUtils.OnCheckSupportListener} used to deliver the response.
     */
