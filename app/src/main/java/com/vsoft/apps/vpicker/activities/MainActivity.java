...
import com.vsoft.apps.vpicker.adapters.MainPagerAdapter;
import com.vsoft.apps.vpicker.data.ColorItems;
import com.vsoft.apps.vpicker.fragments.AboutDialogFragment;
import com.vsoft.apps.vpicker.views.ColorItemListPage;
import com.vsoft.apps.vpicker.views.PaletteListPage;

import vpicker.flavors.MainActivityFlavor;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    /**
     * A {@link MainActivityFlavor} for behaviors specific to flavors.
     */
     ...
     * <p/>
     * {@link com.vsoft.apps.vpicker.activities.MainActivity.PageId}
...
//                }
     ...
     *
     * @param pageId the {@link com.vsoft.apps.vpicker.activities.MainActivity.PageId} of the current selected page.
     */
    ...
    public void onRequestPermissionsResult(
        ...
        Log.d("labot_log_info","MainActivity: Inside onRequestPermissionResult");
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA))
                Toast.makeText(this, "Camera permission is required for VPicker", Toast.LENGTH_LONG).show();
