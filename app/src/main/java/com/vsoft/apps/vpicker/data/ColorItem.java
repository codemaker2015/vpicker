...
public class ColorItem implements Parcelable {
    ...
    /**
     * Create a new {@link com.vsoft.apps.vpicker.data.ColorItem} with an id and a color.
     *
     * @param id    the id of the {@link com.vsoft.apps.vpicker.data.ColorItem}. Should be unique.
    ...
    /**
     * Create a new {@link com.vsoft.apps.vpicker.data.ColorItem} from a {@link android.os.Parcel}.
     * <p/>
     * Used by the parcelable creator.
     * {@link com.vsoft.apps.vpicker.data.ColorItem#CREATOR}.
     *
    ...
    /**
     * Create a new {@link com.vsoft.apps.vpicker.data.ColorItem} with a color.
     * <p/>
     * The {@link com.vsoft.apps.vpicker.data.ColorItem#mId} is set to the {@link com.vsoft.apps.vpicker.data.ColorItem#mCreationTime}.
     *
     * @param color the color value.
     */
    ...
    /**
     * Get the id of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     *
     * @return the id of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     */
    public long getId() {
        return mId;
    }
    ...
    /**
     * Get the value of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     *
     * @return an integer representing the color value of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     */
    public int getColor() {
        return mColor;
    }
    ...
    /**
     * Set the color valur of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     *
     * @param color an integer representing the new color value of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     */
    ...
    /**
     * Get the creation time of the {@link com.vsoft.apps.vpicker.data.ColorItem}.
     *
    ...
    /**
     * A {@link android.os.Parcelable.Creator} for creating {@link com.vsoft.apps.vpicker.data.ColorItem} from {@link android.os.Parcel}.
     */
