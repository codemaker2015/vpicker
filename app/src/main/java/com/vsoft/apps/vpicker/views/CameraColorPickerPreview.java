...
public class CameraColorPickerPreview extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    /**
     * An {@link com.vsoft.apps.vpicker.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is being selected.
     */
    ...
    /**
     * Set a {@link com.vsoft.apps.vpicker.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is selected.
     *
     * @param onColorSelectedListener the {@link com.vsoft.apps.vpicker.views.vpickerPreview.OnColorSelectedListener} that will be called.
     */
