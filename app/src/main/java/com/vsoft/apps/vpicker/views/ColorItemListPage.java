...
import com.vsoft.apps.vpicker.activities.ColorDetailActivity;
...
/**
 * A simple {@link FrameLayout} used in the {@link android.support.v4.view.ViewPager} of the {@link com.vsoft.apps.vpicker.activities.MainActivity}
...
public class ColorItemListPage extends FrameLayout implements ColorItemListWrapper.ColorItemListWrapperListener {
    ...
    /**
     * A {@link com.vsoft.apps.vpicker.data.ColorItems.OnColorItemChangeListener} for listening the creation of new {@link com.vsoft.apps.vpicker.data.ColorItem}s.
     */
