...
import com.vsoft.apps.billing.SupportActivity;
import com.vsoft.apps.billing.utils.SupportUtils;
import com.vsoft.apps.vpicker.R;
import com.vsoft.apps.vpicker.activities.MainActivity;

/**
 * The behavior of the {@link com.vsoft.apps.vpicker.activities.MainActivity} specific to the googleplay product flavor.
 * This class should be present in all the product flavors.
 */
public class MainActivityFlavor {

    /**
     * A {@link com.vsoft.apps.vpicker.activities.MainActivity}.
     */
